...
//! [`codec`], the container [`CommonHeader`] parse, the [`hash_path`] an index is keyed by, and
//! [`GameData`] install enumeration; the index reader, dat-entry extraction, and the integrity
//! inspector build on top of these.
//!
